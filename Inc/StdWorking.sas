/**************************************************************************
 Program:  StdWorking.sas
 Project:  Urban-Greater DC
 Author:   Rob Pitingolo
 Updated:  2/5/26
 Version:  SAS 9.4
 
 Description:  Standard header file for working sessions on SAS1. This is meant
			   to run as the "local" replacement to StdLocal.sas but when working
			   directly on SAS1 rather than a local computer. 
